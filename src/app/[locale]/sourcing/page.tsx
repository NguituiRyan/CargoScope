...
export const metadata: Metadata = {
  ...
  description:
    "Activate a managed China supplier search with supplier comparison, MOQ comparison, price negotiation and shortlisting.",
      ...
      <section className="mx-auto w-full max-w-6xl px-4 pb-8 pt-10 sm:pt-14">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 max-w-2xl text-base leading-7 text-muted-foreground sm:text-lg">
            Tell us what you need—even if all you have is a photo, video or link. We search China&apos;s supplier market, compare options and negotiate the first price and MOQ conversations for you.
          </p>
        </div>
