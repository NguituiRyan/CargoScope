...
export default async function AdminSourcingPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <div className="flex flex-col gap-6"><div><p className="text-sm font-bold text-primary uppercase">Lead & request management</p><h1 className="font-heading text-3xl font-bold">Sourcing requests</h1><p className="mt-1 text-sm text-muted-foreground">Payment-linked RFQs from New through Completed.</p></div>
