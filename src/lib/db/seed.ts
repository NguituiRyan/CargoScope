...
/**
 * Real product photos (sourced from made-in-china.com listings, stored under
 * public/products/), keyed by product title. Falls back to PLACEHOLDER for any
 * unmapped product.
 */
const PRODUCT_IMAGE: Record<string, string> = {
  "10,000mAh Slim Power Bank": "/products/curated-10000mah-slim-power-bank.jpg",
  "True Wireless Earbuds (ENC)": "/products/curated-true-wireless-earbuds-enc.jpg",
  "RGB LED Strip 5m Kit": "/products/curated-rgb-led-strip-5m-kit.jpg",
  "USB-C 100W Braided Cable": "/products/curated-usb-c-100w-braided-cable.jpg",
  '1.83" Bluetooth Smart Watch': "/products/curated-1-83-bluetooth-smart-watch.jpg",
  "5-Piece Nonstick Cookware Set": "/products/curated-5-piece-nonstick-cookware-set.png",
  "Glass Food Container Set (10pc)": "/products/curated-glass-food-container-set-10pc.jpg",
  "750ml Insulated Steel Bottle": "/products/curated-750ml-insulated-steel-bottle.jpg",
  "Digital Kitchen Scale 5kg": "/products/curated-digital-kitchen-scale-5kg.jpg",
  "180gsm Cotton Crew T-Shirt": "/products/curated-180gsm-cotton-crew-t-shirt.jpg",
  "Fleece Pullover Hoodie": "/products/curated-fleece-pullover-hoodie.jpg",
  "High-Waist Sports Leggings": "/products/curated-high-waist-sports-leggings.jpg",
  "6-Panel Cotton Cap": "/products/curated-6-panel-cotton-cap.jpg",
  "Matte Liquid Lipstick Set (6)": "/products/curated-matte-liquid-lipstick-set-6.jpg",
  "Vitamin C Facial Serum 30ml": "/products/curated-vitamin-c-facial-serum-30ml.jpg",
  "12-Piece Makeup Brush Set": "/products/curated-12-piece-makeup-brush-set.jpg",
}
...
const manufacturerSeed: ManufacturerSeed[] = [
  ...
  {
    slug: "zhongshan-lumina-lighting",
    company: "Zhongshan Lumina Lighting Co., Ltd",
    ownerEmail: "owner.lumina@shopbuddy.africa",
    city: "Zhongshan",
    vstatus: "verified",
    tier: "verified",
    year: 2010,
    cats: ["Lights & Lighting"],
    certs: ["CE", "RoHS", "SAA", "ISO 9001"],
    responseRate: 94,
    desc: "LED residential, commercial and solar outdoor lighting from the Guzhen lighting hub. High-lumen fixtures with export packaging for African grid and off-grid markets.",
  },
  {
    slug: "ningbo-kitchmaster-appliances",
    company: "Ningbo KitchMaster Appliances Co., Ltd",
    ownerEmail: "owner.kitchmaster@shopbuddy.africa",
    city: "Ningbo",
    vstatus: "verified",
    tier: "verified",
    year: 2008,
    cats: ["Home Appliances"],
    certs: ["CE", "CB", "RoHS", "ISO 9001"],
    responseRate: 91,
    desc: "Small kitchen and home appliances — air fryers, blenders, kettles and fans. OEM/ODM with 110–240V options for African markets.",
  },
  {
    slug: "foshan-comfort-furniture",
    company: "Foshan ComfortLine Furniture Co., Ltd",
    ownerEmail: "owner.comfortline@shopbuddy.africa",
    city: "Foshan",
    vstatus: "verified",
    tier: "verified",
    year: 2012,
    cats: ["Furniture"],
    certs: ["ISO 9001", "BSCI", "SGS"],
    responseRate: 88,
    desc: "Office and home furniture manufacturer in the Shunde furniture belt. Flat-pack engineering for efficient container loading.",
  },
  {
    slug: "jiangsu-suntech-energy",
    company: "Jiangsu SunTech Energy Co., Ltd",
    ownerEmail: "owner.suntech@shopbuddy.africa",
    city: "Suzhou",
    vstatus: "verified",
    tier: "verified",
    year: 2014,
    cats: ["Renewable Energy"],
    certs: ["TUV", "CE", "IEC 61215", "ISO 9001"],
    responseRate: 95,
    desc: "Solar panels, inverters, lithium storage and solar pumping systems. Tier-1 cells with strong East African off-grid project experience.",
  },
  {
    slug: "guangzhou-motorway-parts",
    company: "Guangzhou MotorWay Auto Parts Co., Ltd",
    ownerEmail: "owner.motorway@shopbuddy.africa",
    city: "Guangzhou",
    vstatus: "verified",
    tier: "verified",
    year: 2011,
    cats: ["Vehicle Parts & Accessories"],
    certs: ["IATF 16949", "CE"],
    responseRate: 90,
    desc: "Aftermarket auto and motorcycle parts — braking, filtration, lighting and accessories for Toyota, Nissan and boda-boda fleets common in East Africa.",
  },
  {
    slug: "baoding-travelmate-bags",
    company: "Baoding TravelMate Bags & Luggage Co., Ltd",
    ownerEmail: "owner.travelmate@shopbuddy.africa",
    city: "Baoding",
    vstatus: "verified",
    tier: "verified",
    year: 2015,
    cats: ["Luggage, Bags & Cases"],
    certs: ["BSCI", "ISO 9001"],
    responseRate: 87,
    desc: "Backpacks, trolley luggage and business bags with custom branding. Durable fabrics and hardware tested for long-haul distribution.",
  },
  {
    slug: "shantou-joytoys",
    company: "Shantou JoyToys Industrial Co., Ltd",
    ownerEmail: "owner.joytoys@shopbuddy.africa",
    city: "Shantou",
    vstatus: "verified",
    tier: "verified",
    year: 2013,
    cats: ["Toys"],
    certs: ["EN71", "ASTM F963", "CE"],
    responseRate: 92,
    desc: "Chenghai-based toy maker — RC vehicles, building blocks, dolls and educational toys with compliant safety documentation.",
  },
  {
    slug: "hangzhou-victory-sports",
    company: "Hangzhou Victory Sports Goods Co., Ltd",
    ownerEmail: "owner.victorysports@shopbuddy.africa",
    city: "Hangzhou",
    vstatus: "verified",
    tier: "verified",
    year: 2016,
    ...
    certs: ["ISO 9001", "SGS"],
    responseRate: 89,
    desc: "Fitness, outdoor and team-sports equipment — from yoga mats and dumbbells to camping gear. Retail-ready packaging available.",
  },
  {
    slug: "wenzhou-safeguard-security",
    company: "Wenzhou SafeGuard Security Tech Co., Ltd",
    ownerEmail: "owner.safeguard@shopbuddy.africa",
    city: "Wenzhou",
    vstatus: "verified",
    tier: "verified",
    year: 2012,
    cats: ["Safety & Security"],
    certs: ["CE", "FCC", "ISO 9001"],
    responseRate: 93,
    desc: "CCTV, smart locks, alarms and site-safety equipment. Solar and low-power options suited to installations with unstable grid power.",
  },
  {
    slug: "guangzhou-stridefoot-shoes",
    company: "Guangzhou StrideFoot Footwear Co., Ltd",
    ownerEmail: "owner.stridefoot@shopbuddy.africa",
    city: "Guangzhou",
    vstatus: "identity",
    tier: "basic",
    year: 2017,
    cats: ["Shoes & Accessories"],
    certs: ["BSCI", "ISO 9001"],
    responseRate: 84,
    desc: "Sneakers, sandals, safety and leather shoes with mixed-size carton options and low MOQs for market traders.",
  },
  {
    slug: "yiwu-gemtime-accessories",
    company: "Yiwu GemTime Jewelry & Watches Co., Ltd",
    ownerEmail: "owner.gemtime@shopbuddy.africa",
    city: "Yiwu",
    vstatus: "identity",
    tier: "basic",
    year: 2018,
    cats: ["Jewelry, Eyewear & Watches"],
    certs: ["SGS"],
    responseRate: 82,
    desc: "Fashion watches, sunglasses and stainless-steel jewelry from the Yiwu commodity market, with fast-moving styles updated monthly.",
  },
  {
    slug: "shijiazhuang-caremed-supplies",
    company: "Shijiazhuang CareMed Medical Supplies Co., Ltd",
    ownerEmail: "owner.caremed@shopbuddy.africa",
    city: "Shijiazhuang",
    vstatus: "verified",
    tier: "verified",
    year: 2010,
    ...
    certs: ["CE", "ISO 13485"],
    responseRate: 91,
    desc: "Mobility aids, diagnostics and clinic consumables with CE and ISO 13485 documentation for hospital and pharmacy distributors.",
  },
  {
    slug: "ningbo-brightoffice-stationery",
    company: "Ningbo BrightOffice Stationery Co., Ltd",
    ownerEmail: "owner.brightoffice@shopbuddy.africa",
    city: "Ningbo",
    vstatus: "identity",
    tier: "basic",
    year: 2016,
    cats: ["School & Office Supplies"],
    certs: ["ISO 9001", "FSC"],
    responseRate: 86,
    desc: "School and office stationery — notebooks, writing instruments and desk equipment — with school-tender and back-to-school season experience.",
  },
  {
    slug: "qingdao-happypaws-pet",
    company: "Qingdao HappyPaws Pet Products Co., Ltd",
    ownerEmail: "owner.happypaws@shopbuddy.africa",
    city: "Qingdao",
    vstatus: "identity",
    tier: "basic",
    year: 2019,
    ...
    certs: ["BSCI", "SGS"],
    responseRate: 85,
    desc: "Pet beds, carriers, leashes and feeding accessories in export-grade materials, with private-label options for retail chains.",
  },
  {
    slug: "henan-goldharvest-machinery",
    company: "Henan GoldHarvest Machinery Co., Ltd",
    ownerEmail: "owner.goldharvest@shopbuddy.africa",
    city: "Zhengzhou",
    vstatus: "verified",
    tier: "verified",
    year: 2009,
    cats: ["Commercial Equipment & Machinery"],
    certs: ["CE", "ISO 9001"],
    responseRate: 90,
    desc: "Commercial food and snack machinery — coffee, ice cream, bakery and meat-processing equipment with spare-parts support for African buyers.",
  },
]
